...
def main():
    ...
    divided_block_ranges = [
        ...
        [117800000, 118200000], # 1
        [118200000, 118600000], # 2
        [118600000, 119000000], # 3
        [119000000, 119400000], # 4
        [119400000, 119800000], # 5 
        [119800000, 120200000], # 6 
        [120200000, 120600000], # 7 
        [120600000, 121000000], # 8 
        [121000000, 121400000], # 9 

        [121400000, 121800000], # 10 
        [121800000, 122200000], # 11
        [122200000, 122600000], # 12
        [122600000, 123000000], # 13
        [123000000, 123400000], # 14
        [123400000, 123800000], # 15
        [123800000, 124200000], # 16
        [124200000, 124600000], # 17
        [124600000, 125000000], # 18
        [125000000, 125400000], # 19
    ]
